...
[[i1]]
.Automate top-level menu for CloudForms 4.1
...
https://access.redhat.com/documentation/en-us/red_hat_cloudforms/4.1/html/scripting_actions_in_cloudforms/[Scripting Actions in CloudForms] 
